...
ECHO ============================================================
ECHO SCTE-35 File Path Issue Test - IBE-100
ECHO ============================================================
...
ECHO [INFO] Testing SCTE-35 file path issues...
ECHO [INFO] The error "cannot open preroll_10023.xml" indicates file path problems.
ECHO.

REM --- Test 1: Check if XML file exists ---
ECHO [TEST 1] Checking if XML file exists...
...
"%TSDUCK_BIN%" -I hls %HLS_INPUT% -O file test_basic.ts
...
ECHO.
ECHO ============================================================
ECHO SCTE-35 file path issue test completed.
...
ECHO.
ECHO ============================================================
ECHO SCTE-35 file path test successful!
