...
REM IBE-100 v1.4.0 Launcher Script - New Folder Version
...
echo Location: IBE-100_v1.4.0 folder
echo.
echo Key Features:
...
IF %ERRORLEVEL% EQU 0 (
    ECHO [SUCCESS] IBE-100 v1.4.0 launched successfully from new folder!
    ECHO.
